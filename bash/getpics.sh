...
wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.zip &&
 unzip -d ~/public_html/pics -o -q ~/public_html/pics/pics.zip &&
 rm ~/public_html/pics/pics.zip
 #my work for task 1
 
 wget -q -O ~/public_html/pics/pics.tgz https://zonzorp.net/pics.tgz &&
 tar -C ~/public_html/pics -x -z -f ~/public_html/pics/pics.tgz &&
