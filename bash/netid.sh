...
###commend line processing 
while [ $# -gt 0 ]; do
# case statment
	case "$1" in
	-h | --help )
		echo "usage: $(basename $0) [-v | --verbose] [myinterfacename]"
		exit
		;;
	-v | --verbose )
		verbose=yes
...
#!/bin/bash
#saying to user that it will generate  a report 
echo "Generate Report Foe Every Interface:
...
#ganarete the report for every interface
